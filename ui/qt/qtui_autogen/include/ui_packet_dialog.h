...
public:
    ...
    void setupUi(QDialog *PacketDialog)
    {
        ...
        prefsLayout->setObjectName("prefsLayout");
        chkShowByteView = new QCheckBox(PacketDialog);
        chkShowByteView->setObjectName("chkShowByteView");
