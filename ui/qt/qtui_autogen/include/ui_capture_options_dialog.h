...
public:
    ...
    void setupUi(QDialog *CaptureOptionsDialog)
    {
        ...
        horizontalLayout_comp->setObjectName("horizontalLayout_comp");
        ...
        rbCompressionLZ4->setObjectName("rbCompressionLZ4");

        horizontalLayout_comp->addWidget(rbCompressionLZ4);

        horizontalSpacer_comp = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        formLayout->setLayout(0, QFormLayout::ItemRole::LabelRole, horizontalLayout_8);
        ...
        formLayout->setWidget(1, QFormLayout::ItemRole::LabelRole, gbStopCaptureAuto);
        ...
        formLayout->setWidget(2, QFormLayout::ItemRole::LabelRole, gbTempDir);

        verticalSpacer_3 = new QSpacerItem(20, 40, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        formLayout->setItem(3, QFormLayout::ItemRole::LabelRole, verticalSpacer_3);
    ...
    void retranslateUi(QDialog *CaptureOptionsDialog)
    {
        ...
        ___qtreewidgetitem->setText(9, QCoreApplication::translate("CaptureOptionsDialog", "Capture Filter", nullptr));
        ___qtreewidgetitem->setText(8, QCoreApplication::translate("CaptureOptionsDialog", "Optimize", nullptr));
