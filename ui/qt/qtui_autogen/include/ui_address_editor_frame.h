...
public:
    ...
    void setupUi(AccordionFrame *AddressEditorFrame)
    {
        ...
        nameResolutionPreferencesToolButton->setObjectName("nameResolutionPreferencesToolButton");

        horizontalLayout->addWidget(nameResolutionPreferencesToolButton);

        horizontalSpacer_2 = new QSpacerItem(81, 5, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        addressComboBox->setObjectName("addressComboBox");
        ...
        horizontalSpacer = new QSpacerItem(20, 13, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
    ...
    {
        AddressEditorFrame->setWindowTitle(QCoreApplication::translate("AddressEditorFrame", "Frame", nullptr));
        nameResolutionPreferencesToolButton->setText(QCoreApplication::translate("AddressEditorFrame", "Name Resolution Preferences\342\200\246", nullptr));
        addressLabel->setText(QCoreApplication::translate("AddressEditorFrame", "Address:", nullptr));
        label->setText(QCoreApplication::translate("AddressEditorFrame", "Name:", nullptr));
    } // retranslateUi
