...
public:
    ...
    void setupUi(QFrame *InterfaceToolbar)
    {
        if (InterfaceToolbar->objectName().isEmpty())
            InterfaceToolbar->setObjectName("InterfaceToolbar");
        ...
        interfacesLabel->setObjectName("interfacesLabel");

        horizontalLayout->addWidget(interfacesLabel);

        interfacesComboBox = new QComboBox(InterfaceToolbar);
        interfacesComboBox->setObjectName("interfacesComboBox");
    ...
    {
        InterfaceToolbar->setWindowTitle(QCoreApplication::translate("InterfaceToolbar", "Frame", nullptr));
#if QT_CONFIG(tooltip)
        interfacesLabel->setToolTip(QCoreApplication::translate("InterfaceToolbar", "Select interface", nullptr));
#endif // QT_CONFIG(tooltip)
        interfacesLabel->setText(QCoreApplication::translate("InterfaceToolbar", "Interface", nullptr));
#if QT_CONFIG(tooltip)
        interfacesComboBox->setToolTip(QCoreApplication::translate("InterfaceToolbar", "Select interface", nullptr));
#endif // QT_CONFIG(tooltip)
    } // retranslateUi
