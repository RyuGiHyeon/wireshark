...
public:
    ...
    void setupUi(QWidget *WelcomePage)
    {
        ...
        horizontalSpacer = new QSpacerItem(44, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        bannerLayout->setObjectName("bannerLayout");
        ...
        mainWelcomeBanner->setObjectName("mainWelcomeBanner");

        horizontalLayout_3->addWidget(mainWelcomeBanner);

        bannerSpacer = new QSpacerItem(40, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        horizontalLayout_3->addItem(bannerSpacer);

        flavorBanner = new QLabel(bannerLayout);
        flavorBanner->setObjectName("flavorBanner");
        ...
        openFrame->setObjectName("openFrame");
        ...
        captureFilterLayout->setObjectName("captureFilterLayout");
        ...
        btnInterfaceType->setObjectName("btnInterfaceType");
        ...
        helpLinks->setObjectName("helpLinks");
    ...
    void retranslateUi(QWidget *WelcomePage)
    {
        ...
        mainWelcomeBanner->setText(QCoreApplication::translate("WelcomePage", "<html><head/><body><p><span style=\" font-size:large;\">Welcome to Wireshark</span></p></body></html>", nullptr));
#if QT_CONFIG(tooltip)
        recentLabel->setToolTip(QCoreApplication::translate("WelcomePage", "<html><head/><body><p>Open a file on your file system</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        recentLabel->setText(QCoreApplication::translate("WelcomePage", "<h2>Open</h2>", nullptr));
#if QT_CONFIG(accessibility)
        recentList->setAccessibleName(QCoreApplication::translate("WelcomePage", "Recent capture files", nullptr));
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(accessibility)
        recentList->setAccessibleDescription(QCoreApplication::translate("WelcomePage", "Capture files that have been opened previously", nullptr));
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(tooltip)
        captureLabel->setToolTip(QCoreApplication::translate("WelcomePage", "<html><head/><body><p>Capture live packets from your network.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        captureLabel->setText(QCoreApplication::translate("WelcomePage", "<h2>Capture</h2>", nullptr));
        label->setText(QCoreApplication::translate("WelcomePage", "\342\200\246using this filter:", nullptr));
        btnInterfaceType->setText(QString());
#if QT_CONFIG(accessibility)
        interfaceFrame->setAccessibleName(QCoreApplication::translate("WelcomePage", "Interface list", nullptr));
#endif // QT_CONFIG(accessibility)
#if QT_CONFIG(accessibility)
        interfaceFrame->setAccessibleDescription(QCoreApplication::translate("WelcomePage", "List of available capture interfaces", nullptr));
#endif // QT_CONFIG(accessibility)
        helpLabel->setText(QCoreApplication::translate("WelcomePage", "<h2>Learn</h2>", nullptr));
        helpLinks->setText(QCoreApplication::translate("WelcomePage", "<html><head>\n"
"<style>\n"
"a:link {\n"
"  color: palette(text);\n"
