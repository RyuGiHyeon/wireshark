...
public:
    ...
    void setupUi(QWidget *SplashOverlay)
    {
        if (SplashOverlay->objectName().isEmpty())
            SplashOverlay->setObjectName("SplashOverlay");
        ...
        progressBand->setObjectName("progressBand");
        ...
        horizontalSpacer = new QSpacerItem(116, 50, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_2 = new QSpacerItem(116, 50, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
