...
public:
    ...
    void setupUi(QDialog *Mtp3SummaryDialog)
    {
        if (Mtp3SummaryDialog->objectName().isEmpty())
            Mtp3SummaryDialog->setObjectName("Mtp3SummaryDialog");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, Mtp3SummaryDialog, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, Mtp3SummaryDialog, qOverload<>(&QDialog::reject));
    ...
    {
        Mtp3SummaryDialog->setWindowTitle(QCoreApplication::translate("Mtp3SummaryDialog", "Dialog", nullptr));
    } // retranslateUi
