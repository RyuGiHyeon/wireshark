...
public:
    ...
    void setupUi(QDialog *CaptureInfoDialog)
    {
        if (CaptureInfoDialog->objectName().isEmpty())
            CaptureInfoDialog->setObjectName("CaptureInfoDialog");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, CaptureInfoDialog, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, CaptureInfoDialog, qOverload<>(&QDialog::reject));
