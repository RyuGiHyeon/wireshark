...
public:
    ...
    QLabel *visualSRLabel;
    QSpinBox *visualSRSpinBox;
    QDialogButtonBox *buttonBox;

    void setupUi(QDialog *RtpPlayerDialog)
    {
        if (RtpPlayerDialog->objectName().isEmpty())
            RtpPlayerDialog->setObjectName("RtpPlayerDialog");
        RtpPlayerDialog->resize(750, 600);
        actionExportButton = new QAction(RtpPlayerDialog);
        actionExportButton->setObjectName("actionExportButton");
        actionSaveAudioFromCursor = new QAction(RtpPlayerDialog);
        actionSaveAudioFromCursor->setObjectName("actionSaveAudioFromCursor");
        actionSaveAudioSyncStream = new QAction(RtpPlayerDialog);
        actionSaveAudioSyncStream->setObjectName("actionSaveAudioSyncStream");
        actionSaveAudioSyncFile = new QAction(RtpPlayerDialog);
        actionSaveAudioSyncFile->setObjectName("actionSaveAudioSyncFile");
        actionSavePayload = new QAction(RtpPlayerDialog);
        actionSavePayload->setObjectName("actionSavePayload");
        ...
        menuAudioRouting->setObjectName("menuAudioRouting");
        ...
        menuInaudible->setObjectName("menuInaudible");
        ...
        audioPlot->setObjectName("audioPlot");
        splitter->addWidget(audioPlot);
        streamTreeWidget = new QTreeWidget(splitter);
        streamTreeWidget->setObjectName("streamTreeWidget");
        ...
        horizontalSpacer_4 = new QSpacerItem(20, 10, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_3 = new QSpacerItem(20, 10, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);

        horizontalLayout->addItem(horizontalSpacer_3);

        skipSilenceButton = new QToolButton(RtpPlayerDialog);
        skipSilenceButton->setObjectName("skipSilenceButton");

        horizontalLayout->addWidget(skipSilenceButton);

        horizontalSpacer_7 = new QSpacerItem(20, 10, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
        ...
        minSilenceSpinBox->setObjectName("minSilenceSpinBox");
        ...
        horizontalSpacer_8 = new QSpacerItem(20, 10, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
        ...
        horizontalSpacer_6 = new QSpacerItem(20, 10, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);
        ...
        outputAudioRate->setObjectName("outputAudioRate");
        ...
        jitterSpinBox->setObjectName("jitterSpinBox");
        ...
        horizontalSpacer_2 = new QSpacerItem(20, 10, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        timingComboBox->addItem(QString());
        timingComboBox->addItem(QString());
        timingComboBox->setObjectName("timingComboBox");
        ...
        todCheckBox->setObjectName("todCheckBox");

        horizontalLayout_2->addWidget(todCheckBox);

        horizontalSpacer_5 = new QSpacerItem(48, 24, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        horizontalLayout_2->addItem(horizontalSpacer_5);

        visualSRLabel = new QLabel(RtpPlayerDialog);
        visualSRLabel->setObjectName("visualSRLabel");

        horizontalLayout_2->addWidget(visualSRLabel);

        visualSRSpinBox = new QSpinBox(RtpPlayerDialog);
        visualSRSpinBox->setObjectName("visualSRSpinBox");
        visualSRSpinBox->setMinimum(1000);
        visualSRSpinBox->setMaximum(48000);
        visualSRSpinBox->setStepType(QAbstractSpinBox::AdaptiveDecimalStepType);

        horizontalLayout_2->addWidget(visualSRSpinBox);
...
#if QT_CONFIG(tooltip)
        actionPrepareFilter->setToolTip(QCoreApplication::translate("RtpPlayerDialog", "Prepare a filter matching the selected streams.", nullptr));
#endif // QT_CONFIG(tooltip)
...
"<strong>Uninterrupted Mode</strong>: Ignore the RTP Timestamp. Play the stream as it is completed. This is useful when the RTP timestamp is missing.", nullptr));
        ...
        visualSRLabel->setText(QCoreApplication::translate("RtpPlayerDialog", "Visual Sample Rate:", nullptr));
#if QT_CONFIG(tooltip)
        visualSRLabel->setToolTip(QCoreApplication::translate("RtpPlayerDialog", "<html><head/><body><p>Adjust the sampling rate used for the waveform display. Higher values display higher frequency harmonics but take additional processing time. Values between 1 kHz and 48 kHz are supported.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        visualSRSpinBox->setToolTip(QCoreApplication::translate("RtpPlayerDialog", "<html><head/><body><p>Adjust the sampling rate used for the waveform display. Higher values display higher frequency harmonics but take additional processing time. Values between 1 kHz and 48 kHz are supported.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        visualSRSpinBox->setSuffix(QCoreApplication::translate("RtpPlayerDialog", " Hz", nullptr));
    } // retranslateUi
