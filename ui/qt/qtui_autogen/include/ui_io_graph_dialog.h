...
#if QT_CONFIG(tooltip)
        deleteToolButton->setToolTip(QCoreApplication::translate("IOGraphDialog", "Remove the selected graphs.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        copyToolButton->setToolTip(QCoreApplication::translate("IOGraphDialog", "Duplicate the selected graphs.", nullptr));
#endif // QT_CONFIG(tooltip)
        copyToolButton->setText(QString());
#if QT_CONFIG(tooltip)
        moveUpwardsToolButton->setToolTip(QCoreApplication::translate("IOGraphDialog", "Move the selected graphs upwards.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        moveDownwardsToolButton->setToolTip(QCoreApplication::translate("IOGraphDialog", "Move the selected graphs downwards.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
