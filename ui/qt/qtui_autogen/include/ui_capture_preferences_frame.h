...
public:
    ...
    QCheckBox *aggregationSetVisibilityCheckBox;
    QHBoxLayout *aggreagtionHL;
    QLabel *aggregationLabel;
    QPushButton *aggreagationEditButton;
    QSpacerItem *aggregationHorizontalSpacer;
    ...
    void setupUi(QFrame *CapturePreferencesFrame)
    {
        if (CapturePreferencesFrame->objectName().isEmpty())
            CapturePreferencesFrame->setObjectName("CapturePreferencesFrame");
        ...
        defaultInterfaceSpacer = new QSpacerItem(18, 20, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Minimum);

        horizontalLayout->addItem(defaultInterfaceSpacer);

        defaultInterfaceComboBox = new QComboBox(CapturePreferencesFrame);
        defaultInterfaceComboBox->setObjectName("defaultInterfaceComboBox");
        ...
        captureUpdateIntervalLineEdit->setObjectName("captureUpdateIntervalLineEdit");

        captureUpdateInterval->addWidget(captureUpdateIntervalLineEdit);

        captureUpdateIntervalHorizontalSpacer = new QSpacerItem(0, 0, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
        ...
        aggregationSetVisibilityCheckBox = new QCheckBox(CapturePreferencesFrame);
        aggregationSetVisibilityCheckBox->setObjectName("aggregationSetVisibilityCheckBox");

        verticalLayout->addWidget(aggregationSetVisibilityCheckBox);

        aggreagtionHL = new QHBoxLayout();
        aggreagtionHL->setObjectName("aggreagtionHL");
        aggregationLabel = new QLabel(CapturePreferencesFrame);
        aggregationLabel->setObjectName("aggregationLabel");

        aggreagtionHL->addWidget(aggregationLabel);

        aggreagationEditButton = new QPushButton(CapturePreferencesFrame);
        aggreagationEditButton->setObjectName("aggreagationEditButton");

        aggreagtionHL->addWidget(aggreagationEditButton);

        aggregationHorizontalSpacer = new QSpacerItem(0, 0, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);

        aggreagtionHL->addItem(aggregationHorizontalSpacer);


        verticalLayout->addLayout(aggreagtionHL);

        captureNoInterfaceLoad = new QCheckBox(CapturePreferencesFrame);
        captureNoInterfaceLoad->setObjectName("captureNoInterfaceLoad");

        verticalLayout->addWidget(captureNoInterfaceLoad);

        captureNoExtcapCheckBox = new QCheckBox(CapturePreferencesFrame);
        captureNoExtcapCheckBox->setObjectName("captureNoExtcapCheckBox");
...
#endif // QT_CONFIG(tooltip)
        aggregationSetVisibilityCheckBox->setText(QCoreApplication::translate("CapturePreferencesFrame", "Enable Aggregation View for real-time capturing", nullptr));
#if QT_CONFIG(tooltip)
        aggregationSetVisibilityCheckBox->setToolTip(QCoreApplication::translate("CapturePreferencesFrame", "This option can only be changed when Aggregation Mode is not active.", nullptr));
#endif // QT_CONFIG(tooltip)
        aggregationLabel->setText(QCoreApplication::translate("CapturePreferencesFrame", "Aggregation fields", nullptr));
#if QT_CONFIG(tooltip)
        aggregationLabel->setToolTip(QCoreApplication::translate("CapturePreferencesFrame", "<html><head/><body><p>Fiedls used for aggregation.</p></body></html>", nullptr));
#endif // QT_CONFIG(tooltip)
        aggreagationEditButton->setText(QCoreApplication::translate("CapturePreferencesFrame", "Edit..", nullptr));
