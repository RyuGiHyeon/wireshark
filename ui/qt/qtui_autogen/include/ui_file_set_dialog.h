...
public:
    ...
    void setupUi(QDialog *FileSetDialog)
    {
        ...
        fileSetTree->setObjectName("fileSetTree");
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::SpanningRole, fileSetTree);
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, FileSetDialog, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, FileSetDialog, qOverload<>(&QDialog::reject));
    ...
    {
        FileSetDialog->setWindowTitle(QCoreApplication::translate("FileSetDialog", "Dialog", nullptr));
        label->setText(QCoreApplication::translate("FileSetDialog", "Directory:", nullptr));
