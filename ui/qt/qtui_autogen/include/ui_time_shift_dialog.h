...
public:
    ...
    void setupUi(QDialog *TimeShiftDialog)
    {
        ...
        shiftAllButton->setObjectName("shiftAllButton");
        ...
        shiftAllTimeLineEdit->setObjectName("shiftAllTimeLineEdit");
        ...
        setOneTimeLineEdit->setObjectName("setOneTimeLineEdit");
        ...
        setTwoCheckBox->setObjectName("setTwoCheckBox");
        ...
        extrapolateLabel->setObjectName("extrapolateLabel");
        ...
        unshiftAllButton->setObjectName("unshiftAllButton");
        ...
        QObject::connect(buttonBox, &QDialogButtonBox::accepted, TimeShiftDialog, qOverload<>(&QDialog::accept));
        QObject::connect(buttonBox, &QDialogButtonBox::rejected, TimeShiftDialog, qOverload<>(&QDialog::reject));
    ...
    {
        shiftAllButton->setText(QCoreApplication::translate("TimeShiftDialog", "Shift all packets by", nullptr));
        label_6->setText(QCoreApplication::translate("TimeShiftDialog", "<html><head/><body><p><span style=\" font-size:small; font-style:italic;\">[-][[hh:]mm:]ss[.ddd] </span></p></body></html>", nullptr));
        setOneButton->setText(QCoreApplication::translate("TimeShiftDialog", "Set the time for packet", nullptr));
        label_2->setText(QCoreApplication::translate("TimeShiftDialog", "to", nullptr));
        setTwoCheckBox->setText(QCoreApplication::translate("TimeShiftDialog", "\342\200\246then set packet", nullptr));
        setTwoToLabel->setText(QCoreApplication::translate("TimeShiftDialog", "to", nullptr));
        extrapolateLabel->setText(QCoreApplication::translate("TimeShiftDialog", "and extrapolate the time for all other packets", nullptr));
        label_5->setText(QCoreApplication::translate("TimeShiftDialog", "<html><head/><body><p align=\"right\"><span style=\" font-size:small; font-style:italic;\">[YYYY-MM-DD] hh:mm:ss[.ddd] </span></p></body></html>", nullptr));
        unshiftAllButton->setText(QCoreApplication::translate("TimeShiftDialog", "Undo all shifts", nullptr));
        errorLabel->setText(QString());
        (void)TimeShiftDialog;
    } // retranslateUi
